	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'mist-drift': {
					'0%': { transform: 'translateX(-100%) translateY(0px)', opacity: '0.3' },
					'50%': { transform: 'translateX(50vw) translateY(-20px)', opacity: '0.6' },
					'100%': { transform: 'translateX(100vw) translateY(0px)', opacity: '0.3' }
				},
				'gothic-glow': {
					'0%, 100%': { 
			...
			animation: {
				...
				'gothic-float': 'gothic-float 8s ease-in-out infinite',
				'mist-drift': 'mist-drift 15s linear infinite',
